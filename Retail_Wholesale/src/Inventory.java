...
public class Inventory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Retail_Wholesale_Management_System");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Display_Purchase d= new Display_Purchase();
        try {
        	Thread.sleep(1000);
        	d.setVisible(true);
        }catch(Exception ex) {}
        
        d.setDefaultCloseOperation(Display_Purchase.DISPOSE_ON_CLOSE); 
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       if(exit==0){
    	   try {
    		   Thread.sleep(1000);
    		   JOptionPane.showMessageDialog(null, " Sourabh kumar choudhary wants to Thank You :)");
    	   }catch(Exception ex) {}
